            ...
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    {post.tags.map((tag) => (
                        <span
                            key={tag}
                            className="badge text-bg-primary m-1 w-auto"
                        >
                            {tag}
                        </span>
                    ))}
                    <div
                        className="alert alert-success reactions d-flex justify-content-around"
                        role="alert"
                    >
                        ...
                        <span className="pointer">
                            {post.comments} <FaRegComment />
                        </span>
                        <span className="pointer">
                            {post.shares} <FaPaperPlane />
                        </span>
                    </div>
                </div>
            </div>
